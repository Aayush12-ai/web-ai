      ...
      <div className="flex-grow flex items-center justify-center">
        <div className="bg-gray-100 dark:bg-gray-800 p-8 rounded-lg shadow-md w-full max-w-md">
          ...
          <form onSubmit={handleLogin}>
            ...
            <Button type="submit" variant="login" className="w-full">Login</Button>
          </form>
          <div className="text-center my-4">or</div>
          <div className="flex flex-col gap-4">
            <Button variant="danger" className="w-full flex items-center justify-center gap-2"><FaGoogle className="transition-transform" /> Login with Google</Button>
            <Button variant="ghost" className="w-full flex items-center justify-center gap-2"><FaGithub className="transition-transform" /> Login with GitHub</Button>
          </div>
        </div>
      </div>
      <Footer />
